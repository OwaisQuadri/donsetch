...
const FETCH_PARAMS: &[ParamSpec] = &[
    ...
    ParamSpec {
        ...
        cli: CliKind::Flag,
        required: false,
        help: "auto (default): HTTP first, browser escalation on wall/JS-shell. \"1\": HTTP only (fastest, fails on JS sites). \"2\": browser directly (slower, for known JS-heavy sites).",
    },
    ParamSpec {
        name: "links",
        flag: "links",
